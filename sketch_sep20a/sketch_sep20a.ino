...
#define WIDTH   192 // Matrix width (pixels)
#define MAX_FPS 45 // Maximum redraw rate, frames/second

#if defined(_VARIANT_MATRIXPORTAL_M4_) // MatrixPortal M4
uint8_t rgbPins[]  = {7, 9, 8, 10, 12, 11};
...
Adafruit_Protomatter matrix(
  ...
  false,-2);      // No double-buffering here (see "doublebuffer" example)
...
Adafruit_PixelDust sand(WIDTH, HEIGHT*2, N_GRAINS, 1, 128, false);
